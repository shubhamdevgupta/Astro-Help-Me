...
import com.androiddev.astrohelpme.AstroHelpme
import com.androiddev.astrohelpme.data.local.AppPreference
import com.androiddev.astrohelpme.databinding.ActivityErrorBinding
import com.androiddev.astrohelpme.utils.extns.LottieType
import com.androiddev.astrohelpme.utils.extns.launchActivity
import com.androiddev.astrohelpme.utils.extns.set
...
class ErrorActivity : AppCompatActivity() {
    ...
    private fun setUpViewForNetworkException() {
        ...
        if (isTransactionApi) {
            binding.tvTitle.textColor(this, R.color.purple_200)
    ...
    override fun onBackPressed() {
        when (action) {
            ...
            NAVIGATE_TO_MAIN ->
                launchActivity(AstroHelpme::class.java, forgotAll = true)
            else -> {
